        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6 lg:p-8">
                <div class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <div class="mb-4">
                        <a href="{{ route('students.create') }}" class="bg-cyan-500 dark:bg-cyan-700 hover:bg-cyan-600 py-2 px-4 rounded">Create Students</a>
                    </div>
                            ...
                            <tr>
                                ...
                                <td class="border px-4 py-2 text-center">
                                    <div class="flex justify-center">
                                        ...
                                        <button type="button" onclick="confirmDelete('{{ $student->id }}')" class="bg-pink-400 dark:bg-pink-600 hover:bg-pink-500 dark:hover:bg-pink-700 text-white font-bold py-2 px-4 rounded">Delete</button>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
